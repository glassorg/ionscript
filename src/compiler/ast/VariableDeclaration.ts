...
export class VariableDeclaration implements _Object.Object , Meta.Meta , Variable.Variable , Declaration.Declaration , Node.Node , Typed.Typed , Statement.Statement , Exportable.Exportable {
