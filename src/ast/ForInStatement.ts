...
export class ForInStatement implements _Object.Object , ForStatement.ForStatement , Statement.Statement , Node.Node {
    ...
    static readonly id = 'ForInStatement';
    ...
    static is(value): value is ForInStatement {
        return isForInStatement(value);
    }
}
export function isForInStatement(value): value is ForInStatement {
    return Class.isInstance(ForInStatement, value);
}
